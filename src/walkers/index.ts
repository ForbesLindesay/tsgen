...
export default function walk(node: bt.Statement, ctx: Context): bt.Identifier[] {
  switch (node.type) {
    case 'DeclareFunction': return walkDeclareFunction(node as bt.DeclareFunction, ctx);
    case 'ExportDefaultDeclaration': return walkExportDefaultDeclaration(node as bt.ExportDefaultDeclaration, ctx);
    case 'ExportNamedDeclaration': return walkExportNamedDeclaration(node as bt.ExportNamedDeclaration, ctx);
    case 'FunctionDeclaration': return walkFunctionDeclaration(node as bt.FunctionDeclaration, ctx);
    case 'ImportDeclaration': return walkImportDeclaration(node as bt.ImportDeclaration, ctx);
    case 'TypeAlias': return walkTypeAlias(node as bt.TypeAlias, ctx);
    case 'VariableDeclaration': return walkVariableDeclaration(node as bt.VariableDeclaration, ctx);
    default:
      writeFileSync(
